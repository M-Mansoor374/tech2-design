    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900">
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-pink-500/20 to-purple-500/20 backdrop-blur-sm border border-white/20 rounded-full text-sm font-medium text-pink-300 mb-6">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold mb-8 leading-tight">
            <span className="text-white">Empowering Your Business</span>
            <br />
          ...
          <p className="text-xl sm:text-2xl text-gray-300 leading-relaxed max-w-3xl mx-auto mb-12">
            At <span className="text-pink-300 font-semibold">Tech2Design</span>, we deliver smart solutions powered by artificial intelligence, designed to enhance efficiency and drive innovation. Our AI integration services transform how businesses operate, from automating customer interactions to leveraging data for strategic insights.
          </p>

          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <Link 
              href="/contact"
              className="group px-8 py-4 bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-500 hover:to-purple-500 text-white font-semibold rounded-xl transition-all duration-300 transform hover:scale-105 shadow-2xl hover:shadow-pink-500/25 flex items-center space-x-3"
            >
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl sm:text-5xl font-bold text-white mb-6">AI Technology Showcase</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Experience the power of artificial intelligence and advanced data processing
            </p>
          </div>
            ...
            <div className="relative group">
              <div className="relative overflow-hidden rounded-3xl shadow-2xl transform transition-all duration-500 group-hover:scale-105 group-hover:shadow-3xl">
                <Image
                  ...
                  alt="AI Integration Showcase - Glowing Translucent Cubes"
                  width={500}
                  height={400}
              ...
              <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-pink-600 to-purple-600 text-white px-6 py-3 rounded-full shadow-lg opacity-0 group-hover:opacity-100 transition-all duration-500 group-hover:-translate-y-2">
                <span className="text-sm font-semibold">Advanced AI Processing</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Our Solutions Include Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl sm:text-5xl font-bold text-white mb-6">Our Solutions Include</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            ...
            <div className="group">
              <div className="relative p-8 bg-gradient-to-br from-pink-500/10 to-purple-500/10 backdrop-blur-xl border border-white/10 rounded-2xl transition-all duration-500 transform hover:scale-105 hover:translate-y-[-5px] hover:shadow-2xl">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-2xl font-bold text-white mb-4">Intelligent Chatbots</h3>
                  <p className="text-gray-300 leading-relaxed">
                    Enhance customer service with AI-driven chatbots that provide instant, accurate responses and improve user satisfaction.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="group">
              <div className="relative p-8 bg-gradient-to-br from-purple-500/10 to-blue-500/10 backdrop-blur-xl border border-white/10 rounded-2xl transition-all duration-500 transform hover:scale-105 hover:translate-y-[-5px] hover:shadow-2xl">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    Utilize AI to analyze data trends and make informed decisions, boosting your business&apos;s strategic capabilities.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="group">
              <div className="relative p-8 bg-gradient-to-br from-blue-500/10 to-cyan-500/10 backdrop-blur-xl border border-white/10 rounded-2xl transition-all duration-500 transform hover:scale-105 hover:translate-y-[-5px] hover:shadow-2xl">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-2xl font-bold text-white mb-4">Tailored AI Applications</h3>
                  <p className="text-gray-300 leading-relaxed">
                    We customize AI solutions to fit your specific business needs, ensuring seamless integration and maximum impact.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="group">
              <div className="relative p-8 bg-gradient-to-br from-cyan-500/10 to-emerald-500/10 backdrop-blur-xl border border-white/10 rounded-2xl transition-all duration-500 transform hover:scale-105 hover:translate-y-[-5px] hover:shadow-2xl">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    Our AI systems are designed to learn and adapt, continually improving their performance and effectiveness.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 bg-black/20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl sm:text-5xl font-bold text-white mb-6">Benefits of Our AI Integration</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            ...
            <div className="text-center group">
              <div className="relative p-8 bg-gradient-to-br from-pink-500/10 to-purple-500/10 backdrop-blur-xl border border-white/10 rounded-2xl transition-all duration-500 transform hover:scale-105 hover:translate-y-[-5px] hover:shadow-2xl">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    Stay ahead with cutting-edge AI technologies that enhance your business capabilities.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="text-center group">
              <div className="relative p-8 bg-gradient-to-br from-purple-500/10 to-blue-500/10 backdrop-blur-xl border border-white/10 rounded-2xl transition-all duration-500 transform hover:scale-105 hover:translate-y-[-5px] hover:shadow-2xl">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-2xl font-bold text-white mb-4">Efficiency Boost</h3>
                  <p className="text-gray-300 leading-relaxed">
                    Automate repetitive tasks and streamline operations to increase productivity.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="text-center group">
              <div className="relative p-8 bg-gradient-to-br from-blue-500/10 to-cyan-500/10 backdrop-blur-xl border border-white/10 rounded-2xl transition-all duration-500 transform hover:scale-105 hover:translate-y-[-5px] hover:shadow-2xl">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    Harness the power of AI to gain valuable insights and optimize decision-making.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <div className="relative p-12 bg-gradient-to-br from-pink-500/10 to-purple-500/10 backdrop-blur-xl border border-white/20 rounded-3xl">
            <div className="absolute inset-0 bg-gradient-to-br from-pink-400/5 to-purple-400/5 rounded-3xl opacity-0 hover:opacity-100 transition-opacity duration-500"></div>
            <div className="relative z-10">
              <h2 className="text-4xl sm:text-5xl font-bold text-white mb-6">
                Ready to Transform Your Business with AI?
              </h2>
              <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                Contact us today to start your AI integration journey and unlock the full potential of intelligent solutions.
              </p>
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                <Link 
                  href="/contact"
